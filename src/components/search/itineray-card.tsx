...
const OneWayOfItinerary = ({
  ...
  return (
    <div className="flex justify-between h-12">
      <div className="flex justify-between basis-[320px]">
        ...
        <div className="flex flex-col basis-[110px] shrink-0 hidden-flight-time">
      ...
      <div className="flex justify-end items-start self-center shrink-0 hidden-luggage">
        <Image
